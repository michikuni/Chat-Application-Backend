...
interface ConversationRepository: JpaRepository<ConversationEntity, Long>{
    ...
    @Query("SELECT cs.id, cm1.user_id, ms.sender_id, us.name, cs.conversation_name, us.avatar, ms.content, ms.media_file, ms.created_at, ms.is_sent, cs.theme_color, cs.conversation_type " +
